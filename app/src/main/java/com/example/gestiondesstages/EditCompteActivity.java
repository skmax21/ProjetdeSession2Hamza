...
public class EditCompteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(editMode) {
            ...
            typeCompte = intent.getIntExtra("TYPECOMPTE",2);
            imageCompte = intent.getStringExtra("IMAGE");



            txtNomPersonne.setText(nom);
            txtPrenomPersonne.setText(prenom);
            txtEmailPersonne.setText(email);
            txtMdpPersonne.setText(mdp);


                if(imageCompte.equals("null")){

                    compteImage.setImageResource(R.drawable.ic_person_24);
                }else {
                    compteImage.setImageURI(imageUri);
                }
        ...
        btnAjouterCompte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getData();
                startActivity(new Intent(EditCompteActivity.this,ListeElevesActivity.class));
